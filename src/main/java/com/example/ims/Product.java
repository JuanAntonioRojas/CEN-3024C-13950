...
public class Product {
    ...
    public Product(String sku, String name, String description, int quantity, double price) {
        this.sku = sku;
        this.name = name;
    ...
    //  This method returns a string that contains meaningful information about the product's current state,
